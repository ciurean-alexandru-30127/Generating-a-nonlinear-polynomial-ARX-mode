...
numar_parametrii=0;
for i=1:m
    grad_polinom=cat(1,grad_polinom,i*ones(na,1));% aceasta secventa de cod este folosita pentru a reprezenta MSE in functie de m si na sub forma de tabel
    numar_parametrii=cat(1,numar_parametrii,2*(1:na)');% am luat doua variabile in care am salvat pe m si na pentru a da titlul fiecarei coloane din tabel
...
% in secventa de cod de mai sus am creat tabele pentru fiecare situatie in
% parte
